        ...
        \column{0.6\textwidth}
            \begin{outline}
                ...
                \1 Para encontrar $f(0,1)$:
                    \uncover<2->{\2 \textcolor<2>{red}{inicia-se pela raiz}}
                    \uncover<3->{\2 \textcolor<3>{red}{como $x$ é $0$, segue-se pela linha pontilhada}}
                    \uncover<4->{\2 \textcolor<4>{red}{como $y$ é $1$, segue-se pela linha sólida}}
                    \uncover<5->{\2 \textcolor<5>{red}{chega-se à folha $0$; logo $f(0,1) = 0$}}
            \end{outline}
...
\begin{frame}{teste}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw[thick] (y1) to (1);
            \draw[dashed, thick, red] (y2) to (0);
            \draw[thick, red] (y2) to (1);
            ...
            % Arrow with text
            \node[fill=white, single arrow, draw=black] at (6.5,4.0) {\scriptsize Simplificação C3};
            
            % Rightmost graph
            \node (z_) at (10.0, 5.5)  {$z$};
            \node (x1_) at (8.5, 4.0)  {$x$};
            \node (x2_) at (11.5, 4.0)  {$x$};
            
            \node (y1_) at (7.6, 2.5)  {$y$};
            \node (y2_) at (9.4, 2.5)  {$y$};
            \node (y3_) at (10.6, 2.5)  {$y$};
            \node (y4_) at (12.4, 2.5)  {$y$};
            
            \node[rectangle, scale=0.7] (0_) at (8.5, 0.5) {$0$};
            \node[rectangle, scale=0.7] (1_) at (11.5, 0.5) {$1$};

            \draw[dashed, thick] (z_) -- (x1_);
            \draw[thick] (z_) -- (x2_);
            \draw[dashed, thick] (x1_) -- (y1_);
            \draw[thick] (x1_) -- (y2_);
            \draw[dashed, thick] (x2_) -- (y3_);
            \draw[thick] (x2_) -- (y4_);
            ...
            \draw[dashed, thick] (y3_) to (0_);
            \draw[thick] (y3_) to (1_);
...
\begin{frame}{Remoção de nós não-terminais duplicados}
    ...
    \begin{columns}[c]
        \column{0.4\textwidth}
            ...
            \begin{center}
                \begin{tikzpicture}
                    ...
                    \tikzset{font=\small, level distance=1.5cm, sibling distance=1mm}
                    \tikzset{every node/.style={circle, minimum height=5mm, draw=black, thick, align=center, text depth = 0pt}}
                    \tikzset{edge from parent/.style={draw=black, thick}}
                    ...
                    \Tree[.\node{$z$};
                        ...
                        [.\node{$x$};
                            ...
                            [.\node(yl2){$y$};
                                \edge[dashed];
                                [.\node(0)[left=1.0mm of yl1,rectangle]{$0$}; ]
                            ]
                        ]
                        \edge[solid];
                        [.\node{$x$};
                            ...
                            [.\node(yr2){$y$};
                                \edge[dashed];
                                [.\node(1)[left=1.0mm of yr1,rectangle]{$1$}; ] 
                            ]
                        ]
                    ]        
                    
                    \draw[dashed, thick] (yl1) to (0);
                    \draw[solid, thick] (yl1) to (1);
                    
                    \draw[solid, thick] (yl2) to (1);
                    
                    \draw[dashed, thick] (yr1) to (0);
                    \draw[solid, thick] (yr1) to (1);
                    
                    \draw[solid, thick] (yr2) to (0);
                \end{tikzpicture}
            \end{center}
        ...
        \column{0.2\textwidth}   
            ...
            \begin{center}
                \begin{tikzpicture}[every node/.style={single arrow, draw=black}]
                    \node[fill=white]{\scriptsize Simplificação C3};
                \end{tikzpicture}
            \end{center}
                ...
                \begin{tikzpicture}
                    ...
                    \Tree[.\node{$z$};
                        ...
                        [.\node{$x$};
                            ...
                            [.\node(yc){$y$};
                                \edge[dashed];
                                [.\node(0)[left=1.0mm of yl,rectangle]{$0$}; ]
                            ]
                        ]
                        \edge[solid];
                        [.\node(xr){$x$};
                            ...
                            [.\node(yr){$y$};
                                \edge[dashed];
                                [.\node(1)[left=1.0mm of yc,rectangle]{$1$}; ] 
                            ]
                        ]
                    ]        
                    
                    \draw[dashed, thick] (yl) to (0);
                    \draw[solid, thick] (yl) to (1);
                    
                    \draw[dashed, thick] (xr) to (yc);
                    
                    \draw[solid, thick] (yc) to (1);
                    
                    \draw[solid, thick] (yr) to (0);                    
                \end{tikzpicture}
            \end{center}
...
%-------------------------------------------
\begin{frame}{Mais simplificações}
    ...
    \begin{columns}[c]
        ...
        \column{0.2\textwidth}   
            ...
            \begin{center}
                \begin{tikzpicture}[every node/.style={single arrow, draw=black}]
                    \node[fill=white]{\scriptsize C3 + C2};
                \end{tikzpicture}
            \end{center}
        ...
        \column{0.4\textwidth}            
            ...
            \begin{center}
                \begin{tikzpicture}
                    ...
                    \tikzset{font=\small, level distance=1.5cm, sibling distance=10.0mm}
                    \tikzset{every node/.style={circle, minimum height=5mm, draw=black, thick, align=center, text depth = 0pt}}
                    \tikzset{edge from parent/.style={draw=black, thick}}
                
                    \Tree[.\node{$z$};
                        \edge[dashed];
                        [.\node[below left=2.0mm of x](yl){$y$};
                            \edge[dashed];
                            [.\node(0)[below=8.0mm of yr,rectangle]{$0$}; ]
                        ]
                        \edge[solid];
                        [.\node(x){$x$};
                            \edge[solid];
    ...
    \begin{quotation}
    \noindent\footnotesize\justifying
        O DDB ainda pode ser simplificado com a remoção de um dos nós $y$ duplicados (novo C3) e a remoção de um ponto de decisão $x$ redundante (novo C2)
    \end{quotation}
