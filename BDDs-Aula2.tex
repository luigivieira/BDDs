...
\begin{frame}{Consequências da forma canônica}
    ...
    \begin{outline}
        ...
        \uncover<5->{
            ...
            \1 \textbf{Teste de implicação}. Pode-se testar se uma função $\phi$ implica em outra $\psi$ calculando o ROBDD para $\phi \land \lnot{\psi}$; a implicação é verdadeira se e somente este ROBDD é igual a $B_0$.
        }
    \end{outline}
