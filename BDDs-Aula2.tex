...
\begin{frame}{Pseudocódigo de \texttt{BUILD}}
    ...
    \begin{algorithm}[H]
        \begin{algorithmic}[1]
            \Function{BUILD}{$v,\varepsilon_{t},\varepsilon_{f}$}
                \If{$\varepsilon_{t},\varepsilon_{f} \in \{0,1\}$}
                    \State \Return $\Call{INS}{v,\varepsilon_{t},\varepsilon_{f}}$
                \EndIf
                \If{$\varepsilon_{f} \in \{0,1\}$}
                    \State \Return $\Call{INS}{v,\Call{BUILD}{\varepsilon_{t}},\varepsilon_{f}}$
                \EndIf
                \If{$\varepsilon_{t} \in \{0,1\}$}
                    \State \Return $\Call{INS}{v,\varepsilon_{t},\Call{BUILD}{\varepsilon_{f}}}$
                \EndIf
                \State \Return $\Call{INS}{v,\Call{BUILD}{\varepsilon_{t}},\Call{BUILD}{\varepsilon_{f}}}$
            \EndFunction
        \end{algorithmic}
    \end{algorithm}
